...
var fight = function(enemy) {
  while (playerInfo.health > 0 && playerInfo.health > 0) {
...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter ond: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
  );
